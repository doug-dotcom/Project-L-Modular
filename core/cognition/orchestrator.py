...
def run_cognitive_core(
    ...
    memory_applicability = build_memory_applicability_packet(
        message,
        cue_driven_memory,
        memory_counterexample,
        rhee_packet or {},
    )
    memory_temporal_drift = build_memory_temporal_drift_packet(
        message,
        cue_driven_memory,
        memory_applicability,
        rhee_packet or {},
    )
    memory_privacy = build_memory_privacy_packet(
        message,
        cue_driven_memory,
    ...
    memory_emotional_salience = build_memory_emotional_salience_packet(
        message,
        cue_driven_memory,
        memory_identity,
        rhee_packet or {},
